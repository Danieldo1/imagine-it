    ...
    <div className="h-full">
      ...
      <div className="container pt-24 md:pt-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div className="flex flex-col w-full xl:w-2/5 justify-center lg:items-start overflow-y-hidden">
          <h1 className="my-4 text-4xl md:text-5xl text-primary opacity-75 font-bold leading-tight text-center md:text-left">
          Unleash Your Imagination,<br />
            <span className="text-[#ca1a40] px-2  text-4xl md:text-5xl font-bold">
            Refine Reality!
            </span>
          </h1>
          <p className="leading-normal font-bold text-xl md:text-2xl text-[#b41739] mb-8 text-center md:text-left">
        ...
        <div>
          ...
          <div className=' w-full xl:w-3/5 p-12 overflow-hidden'>
          <Image width={250} height={250} alt='Example Image' className="md:w-4/5 mx-auto rounded-2xl w-full transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-50" src="/sketch.png" />
        ...
        <div className="w-full xl:w-3/5 p-12 overflow-hidden">
          <Image alt='Example Image'  width={250} height={250} className="mx-auto rounded-2xl  w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6" src="/result.png" />
        </div>
